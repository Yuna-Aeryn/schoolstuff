...
//        menu.forEach(m -> System.out.printf("[%d] %s\n", idx.getAndIncrement(), m));
    ...
    private void checkOrder() {
        ...
        total += order.getSelOptions().stream().mapToInt(Option::price).sum();
    ...
    public static void main(String[] args) {
        KioskAppV2 app = new KioskAppV2(new RestMenuLoader()); // 어떤 메뉴 로더를 사용할 것인지 결정.
        app.start();
    }
}